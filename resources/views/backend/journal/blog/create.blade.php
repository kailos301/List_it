    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block" href="{{ route('admin.blog_management.blogs', ['language' => $defaultLang->code]) }}">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="blogForm" action="{{ route('admin.blog_management.store_blog') }}" method="POST" enctype="multipart/form-data">
                @csrf
