  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add Car Brand') }}</h5>
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create" action="{{ route('admin.car_specification.store_brand') }}"
          method="post">
          @csrf
          ...
          <div class="form-group">
            ...
            <p class="text-warning mt-2 mb-0">
              <small>{{ __('The higher the serial number is, the later the barnd will be shown.') }}</small>
            </p>
          </div>
        </form>
      </div>
