        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-10 offset-lg-1">
              ...
              <form id="carForm" action="{{ route('admin.car_management.store_car') }}" method="POST"
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      ...
                      <p class="text-warning">
                        {{ __('if you do not select any vendor, then this car will be listed for Admin') }}</p>
                    </div>
                  </div>
        ...
        <div class="card-footer">
          <div class="row">
            <div class="col-12 text-center">
              <button type="submit" id="CarSubmit" class="btn btn-success">
                {{ __('Save') }}
              </button>
            </div>
          </div>
