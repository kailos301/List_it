    ...
    <div class="container custom-container">
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="more-option mobile-item">
          ...
          <div class="item">
            <div class="dropdown">
              <button class="btn btn-outline btn-md rounded-pill dropdown-toggle" type="button"
          ...
          <div class="item">
            <div class="dropdown">
              <button class="btn btn-primary btn-md rounded-pill dropdown-toggle" type="button"
                data-bs-toggle="dropdown" aria-expanded="false">
